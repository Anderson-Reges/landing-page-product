...
const NavBottom: React.FC = () => {
  return (
    <div className='flex justify-evenly border-b h-16 items-center'>
      ...
      <Dropdown />
      <a href="#" className='hidden text-background-3 font-semibold rounded inline-flex items-center desktop:flex'>
          FEATURES
      </a>
      <a href="#" className='hidden text-background-3 font-semibold rounded inline-flex items-center desktop:flex'>
          TECH SPECS
      ...
      <button className='mobile:hidden desktop:flex bg-primary w-52 h-11 justify-center items-center rounded-3xl font-bold text-background-1'>
        BUY NOW
      </button>
      <a href="#">
